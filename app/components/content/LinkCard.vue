  ...
  <ClientOnly>
    <NuxtLink
      ...
      <div class="group/link-card grid grid-rows-[40%_30%_30%] px-8 py-4">
        <div
          class="text-base whitespace-nowrap text-ellipsis overflow-hidden text-fg group-responsive-hover/link-card:text-fg-strong group-responsive-hover/link-card:underline transition-[text-decoration] duration-350 ease-out"
          data-testid="title">
    ...
    <template #fallback>
      <NuxtLink
        ...
        class="grid grid-cols-[auto_0] block-62 bg-bg-strong border border-split rounded-md transition-colors duration-500">
        <div class="group/link-card grid grid-rows-[40%_30%_30%] px-8 py-4">
          <div class="text-base whitespace-nowrap text-ellipsis overflow-hidden text-fg group-responsive-hover/link-card:text-fg-strong group-responsive-hover/link-card:underline transition-[text-decoration] duration-350 ease-out">
            {{ url }}
          </div>
