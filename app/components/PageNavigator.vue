<template>
  <div class="container flex flex-row flex-wrap justify-center block-22 gap-x-px">
    <NuxtLink
      ...
      class="group block text-center leading-[0.7] content-center min-inline-22 border-be-[0.3rem] border-split aria-hidden:pointer-events-none transition-colors duration-hover ease-hover responsive-hover:border-fg-weak"
      :tabindex="backwardEnabled ? undefined : -1"
      :aria-hidden="backwardEnabled ? undefined : true"
      aria-label="最初のページに戻る">
      <IconChevronsLeft class="text-base m-[calc((2.2rem-1px*2-1rem)/2)] transition-[filter] duration-page-transition ease-page-transition vertical:transform-[rotate(0.25turn)] group-aria-[hidden]:text-fg-weak group-aria-[hidden]:opacity-50" />
    </NuxtLink>
    <NuxtLink
      :to="{
        path: route.path,
      ...
      :aria-hidden="backwardEnabled ? undefined : true"
      aria-label="1ページ前に戻る">
      <IconChevronLeft class="text-base m-[calc((2.2rem-1px*2-1rem)/2)] transition-[filter] duration-page-transition ease-page-transition vertical:transform-[rotate(0.25turn)] group-aria-[hidden]:text-fg-weak group-aria-[hidden]:opacity-50" />
    </NuxtLink>
    <div
    ...
    <NuxtLink
      ...
      aria-label="1ページ次に進む">
      <IconChevronRight class="text-base m-[calc((2.2rem-1px*2-1rem)/2)] transition-[filter] duration-page-transition ease-page-transition vertical:transform-[rotate(0.25turn)] group-aria-[hidden]:text-fg-weak group-aria-[hidden]:opacity-50" />
    </NuxtLink>
    <NuxtLink
      :to="{
        path: route.path,
      ...
      <IconChevronsRight class="text-base m-[calc((2.2rem-1px*2-1rem)/2)] transition-[filter] duration-page-transition ease-page-transition vertical:transform-[rotate(0.25turn)] group-aria-[hidden]:text-fg-weak group-aria-[hidden]:opacity-50" />
    </NuxtLink>
  </div>
</template>
